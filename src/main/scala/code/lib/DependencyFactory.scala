...
import domain.{PermissionManager, PermissionManagerImpl}
...
object DependencyFactory extends Factory {
  ...
  implicit object permissionManager extends FactoryMaker(permissionManagerFunc _)

  def permissionManagerFunc: PermissionManager = new PermissionManagerImpl
